...
# #
# # # Load images
# # image1 = cv2.imread('assets/og/frame_right.png')
# # image2 = cv2.imread('assets/og/frame_right.png')
# #
# # # Camera calibration parameters
# # # These need to be obtained beforehand
# # # camera_matrix = np.array([[fx, 0, cx], [0, fy, cy], [0, 0, 1]])
# # # dist_coeffs = np.array([k1, k2, p1, p2, k3])  # assuming radial distortion
# # #
# # # # 1. Undistort Images
# # # image1_undistorted = cv2.undistort(image1, camera_matrix, dist_coeffs)
# # # image2_undistorted = cv2.undistort(image2, camera_matrix, dist_coeffs)
# # image1_undistorted = image1
# # image2_undistorted = image2
# #
# # # 2. Detect Keypoints and Descriptors
# # sift = cv2.SIFT_create()
# # kp1, des1 = sift.detectAndCompute(image1_undistorted, None)
# # kp2, des2 = sift.detectAndCompute(image2_undistorted, None)
# #
# # # 3. Match Descriptors
# # bf = cv2.BFMatcher()
...
# # img_matches = cv2.drawMatches(image1_undistorted, kp1, image2_undistorted, kp2, good, None, flags=cv2.DrawMatchesFlags_NOT_DRAW_SINGLE_POINTS)
# #
...
# # result = cv2.warpPerspective(image1_undistorted, M,
...
#     # img_names = [ "assets/og/right_01.jpeg", "assets/og/right_02.jpeg", "assets/og/left_01.jpeg", "assets/og/left02.jpeg"]#gargs.im_names
#     img_names = ['assets/export/left_cut_off.png', 'assets/export/right_cut_off.png']
#     img_names = ['assets/og/left_test.jpeg', 'assets/og/right_test.jpeg']
#     print(img_names)
...
#     #
#     # parser.add_argument("--try_cuda", default=False, type=bool)
#     # parser.add_argument("--work_megapix", default=0.6, type=float)
#     # parser.add_argument("--seam_megapix", default=0.1, type=float)
#     # parser.add_argument("--compose_megapix", default=-1, type=float)
#     # parser.add_argument("--conf_thresh", default=1., type=float)
#     # parser.add_argument("--features_type", default="orb", type=str)
#     #
#     # parser.add_argument("--matcher", default="homography", type=str)
#     # parser.add_argument("--estimator", default="homography", type=str)
#     # parser.add_argument("--save-graph", default=False, type=bool)
#     # parser.add_argument("--ba", default="ray", type=str)
#     # parser.add_argument("--ba-refine-mask", default="xxxxx", type=str)
#     # parser.add_argument("--do-wave-correct", default=True, type=bool)
#     # parser.add_argument("--wave_correct", default="vert", choices=["vert", "other_options_here"],
#     #                     type=str)  # Replace "other_options_here" with other possible choices for this argument if any
#     # # parser.add_argument("--save-graph", default=False, type=bool)
#     # # parser.add_argument("--save-graph-to", default="", type=str)
#     # parser.add_argument("--warp", default="plane", type=str)
#     # parser.add_argument("--expos-comp-type", default=0, type=int)  # Replace 0 with actual default if it's different
#     # parser.add_argument("--match-conf", default=0.3, type=float)
#     # parser.add_argument("--seam-find-type", default="voronoi", type=str)
#     # parser.add_argument("--blend-type", default=0, type=int)  # Replace 0 with actual default if it's different
#     # parser.add_argument("--timelapse-type", default=0, type=int)  # Replace 0 with actual default if it's different
#     # parser.add_argument("--blend_strength", default=5, type=float)
#     # parser.add_argument("--timelapse", default='as_is', type=str)
#     # parser.add_argument("--rangewidth", default=-1, type=int)
#     # parser.add_argument("--blend", default="multiband", type=str)
#     # parser.add_argument("--output", default="result.jpg", type=str)
#     # parser.add_argument('--features', type=str, default='orb', help='Your help message here')
#     # Adding the img_names argument with default values
#     parser.add_argument("--img_names", nargs='+', default=[
#                                                             "assets/og/right_01.jpeg",
#                                                            "assets/og/right_02.jpeg", "assets/og/left_01.jpeg", "assets/og/left02.jpeg"]
